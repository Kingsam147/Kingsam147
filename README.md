...
Image sharing platform with analytics tracking and automated user segmentation. Node.js · MongoDB · Redis · React · Docker
...
**Infrastructure** — Redis · Docker · AWS · Supabase · Cloudflare  
